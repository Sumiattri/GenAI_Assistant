...
const ChatInterface = ({ messages, messagesEndRef, hasTyped }) => {
  ...
  return (
    <div className=" flex flex-col lg:w-[50vw] md:w-[67vw] sm:w-[85vw] w-[90vw] mx-auto pt-10 ">
      {messages?.map((msg, i) => (
        <div
          key={i}
          ref={messagesEndRef}
          ...
          className={`text-white py-2 sm:mb-8 mb-2 mt-2 sm:mt-5 rounded-b-3xl  ${
            msg.role === "user"
              ? "bg-[#333537] max-w-[90%] self-end rounded-l-3xl px-6"
              : "rounded-r-3xl self-start "
          }`}
        >
          {msg.role === "assistant" ? (
              ...
              <div className=" flex gap-3 ">
                ...
                <div className="prose prose-invert max-w-none font-[font2]   sm:text-[15px] text-sm font-extralight">
                  <ReactMarkdown
                    ...
                    // }
                    children={
                      msg.content // 👈 Only type the last assistant message
                    }
